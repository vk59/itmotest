...
class Question14Fragment : AbstractQuestionFragment(R.layout.fragment_question14) {
    ...
    override fun getAnswerHint(): Int {
        return when (rootView.findViewById<RadioGroup>(R.id.radioGroup).checkedRadioButtonId){
            R.id.answer1 -> R.string.question_14_answer1_hint
            R.id.answer2 -> R.string.question_14_answer2_hint
            R.id.answer3 -> R.string.question_14_answer3_hint
            R.id.answer4 -> R.string.question_14_answer4_hint
            R.id.answer5 -> R.string.question_14_answer5_hint
