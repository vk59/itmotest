...
class Question11Fragment : AbstractQuestionFragment(R.layout.fragment_question11) {
    ...
    override fun getAnswerHint(): Int {
        return when (rootView.findViewById<RadioGroup>(R.id.radioGroup).checkedRadioButtonId){
            R.id.answer1 -> R.string.question_11_answer1_hint
            R.id.answer2 -> R.string.question_11_answer2_hint
            R.id.answer3 -> R.string.question_11_answer3_hint
            R.id.answer4 -> R.string.question_11_answer4_hint
