...
class Question15Fragment : AbstractQuestionFragment(R.layout.fragment_question15) {
    ...
    override fun getAnswerHint(): Int {
        return when (rootView.findViewById<RadioGroup>(R.id.radioGroup).checkedRadioButtonId){
            R.id.answer1 -> R.string.question_15_answer1_hint
            R.id.answer2 -> R.string.question_15_answer2_hint
            R.id.answer3 -> R.string.question_15_answer3_hint
